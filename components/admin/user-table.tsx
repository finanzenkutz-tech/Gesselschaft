                        ...
                        <tr key={user.id} className="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        {editingId === user.id ? (
                                            ...
                                            <p className="font-bold text-slate-700">{user.full_name || 'Anonym'}</p>
                                        )}
                            ...
                            <td className="py-4 px-6">
                                {editingId === user.id ? (
                                    ...
                                    <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${user.system_role === 'super_admin' ? 'bg-amber-100 text-amber-600' : 'bg-slate-100 text-slate-500'
                                        }`}>
                                        ...
                                        <>
                                            <Button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    setEditData({ full_name: user.full_name, system_role: user.system_role })
                                                }}
                                            >
